                ...
                <el-card class="user-card" shadow="hover">
                    <div class="delivery-section">
                        <div class="section-header">
                            <strong>配送信息</strong>
                            <el-button
                                v-if="!isEditingDeliveryInfo"
                                @click="editDeliveryInfo"
                                class="edit-delivery-info"
                                size="small"
                            >编辑配送信息</el-button>
                            <el-button
                                v-else
...
.el-card {
    ...
    transition: box-shadow 0.3s ease; /* 增加悬浮时的过渡效果 */
}

.el-card:hover {
    box-shadow: 0 6px 25px rgba(0, 0, 0, 0.15); /* 鼠标悬浮时加强阴影 */
}
...
.avatar-img {
    ...
    margin-right: 15px;
    box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); /* 给头像加上轻微阴影 */
}
