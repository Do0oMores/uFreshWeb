<template>
        ...
        <el-col :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <el-card shadow="hover" class="data-card">
            <div class="data-card-content">
              ...
              <el-icon class="data-icon" color="#67C23A"><TrendCharts /></el-icon>
            </div>
          </el-card>
        </el-col>
        <el-col :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <el-card shadow="hover" class="data-card">
            <div class="data-card-content">
              ...
              <el-icon class="data-icon" color="#409EFF"><Document /></el-icon>
            </div>
          </el-card>
        </el-col>
        <el-col :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
        ...
        <el-col :xs="12" :sm="12" :md="6" :lg="6" :xl="6">
          <el-card shadow="hover" class="data-card">
            <div class="data-card-content">
              ...
              <el-icon class="data-icon" color="#F56C6C"><Star /></el-icon>
            </div>
          </el-card>
        </el-col>
      </el-row>
  ...
  export default {
    ...
    setup() {
      ...
      // 刷新库存数据
      const refreshStock = () => {
        barOption.value.series[0].data = generateRandomData(7, 50, 250)
